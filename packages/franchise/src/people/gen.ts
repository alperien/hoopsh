...
/**
 * Prospect quality never reaches a peak superstar's level on day one.
 * SWEPT: 82+8 by the #125 supply-parity sweep (record: #125 comment
 * 5156322787, landed in #173); moves only with a re-sweep.
 */
