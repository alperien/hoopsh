 ...
 * × 3) because it's checking a candidate it's about to commit to rather
 * than sanity-checking a change.
 */
 ...
 * close (<2% leverage). Raise this to NBA_BANDS.length when that debt is
 * paid; never lower it to make a red run green.
 *
