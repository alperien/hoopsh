 ...
 * still look like basketball," not an exact match to the 2023-24 season. A
 ...
 * target; re-verify pace first when a bunch of bands drift together.
 */
...
export const NBA_BANDS: Band[] = [
  ...
  // conversion) and it is now enforced like every other band. The mechanism
  // trail lives in the fidelity-phase commits.
