 ...
 * (write a job JSON with the shape above first, or re-use one sweep.ts left
 * in /tmp — job files are kept when an evaluation FAILS, for exactly this
 * hand-re-run, and unlinked on success).
 */
