  ...
  async render(root) {
    ...
    root.replaceChildren(
      ...
      el('div', { class: 'cols c2' },
        ...
        el('div', {},
          // the head (realism wave): confidence and lifestyle, NBA years only
          me.psyche ? ledger('the head') : null,
          me.psyche ? el('div', { class: 'card', style: 'margin-bottom:10px' },
            el('div', { style: 'display:flex;align-items:center;gap:8px' },
              el('span', { style: 'font-size:11.5px;color:var(--ink-faint);width:74px' }, 'confidence'),
              el('div', { style: 'flex:1' }, meter(me.psyche.confidence)),
              el('span', { style: 'font-size:12px' }, String(me.psyche.confidence)),
            ),
            el('div', { style: 'font-size:12.5px;margin-top:5px' }, me.psyche.confidencePhrase),
            el('div', { style: 'font-size:11.5px;color:var(--ink-faint);margin-top:6px' }, me.psyche.lifestylePhrase),
          ) : null,
          ledger('the body'),
