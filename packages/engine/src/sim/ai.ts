 ...
 *   ai/concepts.ts — cross-cutting concepts 1-8 (decisiveness, action
 *                    commitment, advantage passing, usage pressure, tempo,
 *                    endgame urgency, score pressure incl. the LIVE
 *                    channel-2 defensive coupling, probe culture) — the
 *                    largest ai module and the one AGENTS.md's ownership
 *                    table points at for game-state coupling (its omission
 *                    from this list was scan c3-F3)
...
export { assignedDefender, defendersInLane, onBallDefender, moveSpeed, midPullUpLight } from './ai/shared.js';
export { onShotReleased, onOrebSecured, assignSpots, offenseOffBallTick, clearsDunkGate } from './ai/offense.js';
