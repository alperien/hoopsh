<!-- ============================================================
  ...
  This is the hoopsh Bible: all 13 source documents compiled in canonical
  reading order. Edit the sources, then regenerate: npm run docs:bible
  Sources (in order): README.md · ARCHITECTURE.md · docs/INTERNALS.md · docs/CALIBRATION.md · AGENTS.md · docs/PLAYBOOK.md · docs/EMBEDDING.md · docs/CONTRACT.md · docs/ROSTERS.md · docs/SEASON.md · docs/BROADCAST.md · docs/GLOSSARY.md · docs/ONBOARDING.md
============================================================ -->

# 📖 The hoopsh Bible — everything, one file

> Generated from the 13 source documents. If this file and a source document
...
9. **docs/ROSTERS.md**
10. **docs/SEASON.md**
11. **docs/BROADCAST.md**
12. **docs/GLOSSARY.md**
13. **docs/ONBOARDING.md**
...
> Part 1/13 of the generated Bible — canonical source: `README.md`. Edit there, then `npm run docs:bible`.
...
> Part 2/13 of the generated Bible — canonical source: `ARCHITECTURE.md`. Edit there, then `npm run docs:bible`.
...
> Part 3/13 of the generated Bible — canonical source: `docs/INTERNALS.md`. Edit there, then `npm run docs:bible`.
...
> Part 4/13 of the generated Bible — canonical source: `docs/CALIBRATION.md`. Edit there, then `npm run docs:bible`.
...
> Part 5/13 of the generated Bible — canonical source: `AGENTS.md`. Edit there, then `npm run docs:bible`.
...
> Part 6/13 of the generated Bible — canonical source: `docs/PLAYBOOK.md`. Edit there, then `npm run docs:bible`.
...
> Part 7/13 of the generated Bible — canonical source: `docs/EMBEDDING.md`. Edit there, then `npm run docs:bible`.
...
> Part 8/13 of the generated Bible — canonical source: `docs/CONTRACT.md`. Edit there, then `npm run docs:bible`.
...
> Part 9/13 of the generated Bible — canonical source: `docs/ROSTERS.md`. Edit there, then `npm run docs:bible`.
...
> Part 10/13 of the generated Bible — canonical source: `docs/SEASON.md`. Edit there, then `npm run docs:bible`.
...
> Part 11/13 of the generated Bible — canonical source: `docs/BROADCAST.md`. Edit there, then `npm run docs:bible`.
...
> Part 12/13 of the generated Bible — canonical source: `docs/GLOSSARY.md`. Edit there, then `npm run docs:bible`.
...
> Part 13/13 of the generated Bible — canonical source: `docs/ONBOARDING.md`. Edit there, then `npm run docs:bible`.
