# Refactor log — verification-and-debt (historical record)

> **STATUS (2026-07-29): historical record** of the
> `refactor/verification-and-debt` branch, kept as written. Not a live task
> list — the debt register that used to share this file (rows D1–D9,
> W1–W50) is the live document at [../REGISTER.md](../REGISTER.md).

Every commit on the branch declared one of three change classes and was
...
findings are deferred as a coordinated re-sweep task (see the debt register +
...
The new decision-layer debt registered at this landing (putback share,
steal→score conversion) lives in the register as D8/D9.

## Gate-tier baselines (2026-07-27)

Measured when the realism-gate tiers (the table now in
[../REGISTER.md](../REGISTER.md)) were added:
...
20% vs 35%+ (no intentional fouling — M4). (The putback and steal→score
references here predate the wave-2 corpus corrections — see D8/D9 in the
register for the corrected directions.)
