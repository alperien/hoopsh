...
No CRITICAL or MAJOR findings. Every headline claim survived direct attack.
...
8. Roster tooling: roster:new output validates clean; validator catches duplicate starters (which
   the engine's own validateTeam misses; the schema.ts comment acknowledges this); 8 legal-extreme
